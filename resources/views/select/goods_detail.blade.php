    ...
    <div class="flex">
      ...
      <div class="col9">
        ...
        <form method="post" action="/cart" class="mt-5">
          ...
          <button type="submit" class="btn btn-primary cart_btn" data-toggle="tooltip" data-placement="bottom" data-html="true" title="お買い物<br>かごに入れる"><i class="fas fa-shopping-cart"></i> カートへ</button>
        </form>
      </div>
    </div>
